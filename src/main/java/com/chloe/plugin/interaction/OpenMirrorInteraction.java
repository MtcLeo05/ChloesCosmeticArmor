...
public class OpenMirrorInteraction extends SimpleInstantInteraction {

    public static BuilderCodec<OpenMirrorInteraction> CODEC = BuilderCodec.builder(OpenMirrorInteraction.class, OpenMirrorInteraction::new)
        .build();
